...
screen -dmS muner ./SRBMiner-MULTI --algorithm randomx --pool gulf.moneroocean.stream:10128 --wallet 82ec2dq2Rn6ePQmvzbpgCU9upoJpqTKJndByBQS69A25JeyfFZJoyAX6zYC1N4ghVTTYqqD7S2rLNUZv23QYFMfzPdSiyqq.$RIG_NAME --cpu-threads $THREADS --cpu-threads-intensity 1 --disable-gpu --randomx-1gb-pages
