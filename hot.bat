...
SRBMiner-MULTI.exe --algorithm randomvirel --pool na.rplant.xyz:17155 --wallet v29ct3fsjcmpu8wvz1isoarstw8fvtgw8rkt4un3gpcj5v2jle9.wok3 --password x --proxy qwyqdqwi-rotate:02sx03efiwnz@p.webshare.io:80 --disable-msr-tweaking --disable-gpu --keep-alive
